                        ...
                        do
                            ...
                            do
                                ...
                                python -m mixup.mixup_eval_text \
                                    ...
                                    --wandb_tags oracle_sim_dot \
                                    --device 0 \
                                    --ref_mode oracle \
                                    --model_path checkpoints/clinic150_bert \
                                    --score_calculator.class_path mixup.ood_score_calculators.$method \
                                    --score_calculator.init_args.batch_size 64 \
                                    --score_calculator.init_args.selection_mode argmax \
                                    --score_calculator.init_args.intermediate_state softmax \
                                    --score_calculator.init_args.oracle_sim_mode cosine_sim \
                                    --score_calculator.init_args.oracle_sim_temp $temp \
                                    --fnr_at 0.95 \
                                    --fpr_at 0.95 \
